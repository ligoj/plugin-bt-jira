...
// Library build for the "bt-jira" tool-level plugin. Mirror of the
// plugin-vm-azure config.
...
export default defineConfig({
  ...
  build: {
    ...
    outDir: resolve(import.meta.dirname, '../src/main/resources/META-INF/resources/webjars/bt-jira/vue'),
    emptyOutDir: true,
    rollupOptions: {
